...
public class GroupStageController {
    ...
    private void setGroupStageTeam() {
        ...
        System.out.println(Arrays.toString(teamIndexNum.getTeamIndexNum()));
...
//      1. 팀 스코어 입력
        ...
        inputTeamScoreNum(groupA); // 팀 스코어 입력
...
//        endMatchesRound(teamMatchRecord); // 경기 종료 후
    ...
    private void inputTeamScoreNum(List<Team> groupA) {
        System.out.println("inputTeamScoreNum");
        GroupStageView.inputFirstMatchesScoreNumInfo(groupA);
        String firstTeamScore = scanner.next();
        GroupStageView.inputSecondMatchesScoreNumInfo(groupA);
